...
global.db = new Low(
 ...
 global.db = new Low(new mongoDB('mongodb+srv://Ainemd:f6dnh9WU7SYfnCmT@ainemd.wgm2j.mongodb.net/?retryWrites=true&w=majority'))
...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`628881393308@s.whatsapp.net`, {text: 'Successfully connected by Aine' }) //made by Muhammad Ridwan Reynaldy 
}
